...
import com.tlproject.omada1.tl_project.Activitys.MapsActivity;
import com.tlproject.omada1.tl_project.Activitys.ProfileActivity;
...
public class TestRegistActivityRegistButton {
    @Rule
    ...
    public void checkProfileBackButton() {
        ...
        // Press the button.
        onView(withId(R.id.usernamer)).perform(typeText(String_To_Type),
                closeSoftKeyboard());
        onView(withId(R.id.passwordr)).perform(typeText(String_To_Type),
                closeSoftKeyboard());
        onView(withId(R.id.cpassword)).perform(typeText(String_To_Type),
                closeSoftKeyboard());
